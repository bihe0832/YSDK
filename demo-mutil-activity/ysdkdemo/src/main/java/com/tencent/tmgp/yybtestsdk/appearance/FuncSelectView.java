...
public class FuncSelectView {
    ...
    public void createDialogView(String viewTitle, ArrayList<YSDKDemoApi> apiList)
	{
		...
		for(final YSDKDemoApi api : apiList)
		{
    ...
    public void createInputView(final YSDKDemoApi api) {
    	LayoutInflater inflater = mActivity.getLayoutInflater();
    	LinearLayout rootView = (LinearLayout) inflater.inflate(R.layout.select_window, null);
